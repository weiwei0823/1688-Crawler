!function (n, t, r, i, a, e, o, c, u, f, s, l, m, h, v) {
    var p, d = "3.9.12", g = "isg", y = c, b = !!y.addEventListener, w = u.getElementsByTagName("head")[0],
        _ = f.userAgent;
    !function (n) {
        function t() {
        ...
        n.a = t;
        var g = /native code/, w = r.prototype.toString;
        n.b = e, n.c = o, n.d = a.now || function () {
            console.log(+new a, "--------date-1");
            return +new a
        }, n.e = c, n.f = f;
        var _ = /^(?:https?:)?\/{2,}([^/?#\\]+)/i, k = /[@:]/;
    ...
    !function (n) {
        ...
        function a(n, t, r) {
            if (!(_.indexOf("XueXi") >= 0)) {
                n = (n || "").substr(0, 2e3);
                var i = e(), a = {url: n, token: t, cna: i, ext: r}, o = "fourier.taobao.com";
    ...
    !function (n) {
        ...
        function o(n) {
            if (D = n.isTrusted, b) {
                var r = n.target, a = r.offsetWidth >> 1, e = r.offsetHeight >> 1;
                if (!(a < 10 && e < 10)) {
                    var o = i.abs(n.offsetX - a), u = i.abs(n.offsetY - e), f = o < 2 && u < 2;
        ...
        var D, N, Y, G, Q, U = 0, $ = 0, J = 0, V = 0, K = 0, Z = 0, nn = !0, tn = 0, rn = 0, an = 0, en = 0, on = !0,
            cn = !1, un = !!y.DeviceOrientationEvent;
    ...
    !function (n) {
        ...
        function d() {
            var n = p.l(), t = p.m(), r = j.O(), i = r[0], a = r[1];
        ...
        var A = !0, E = 0, F = t(16), T = [r, i, e, o, s], M = [l, m, h, v, g, d];
        n.Z = g, n.$ = k;
        var B = f.vendor, L = w.style, W = "chrome" in c, S = "ActiveXObject" in c, C = p.b(y.WeakMap), O = {
            _13: function () {
    ...
    var M, B = function () {
        ...
        return n.prototype.na = function () {
            for (var n = this.ma, t = [], r = -1, i = 0, a = n.length; i < a; i++) for (var e = this[i], o = n[i], c = r += o; t[c] = 255 & e, 0 != --o;) --c, e >>= 8;
            return t
    ...
    !function (n) {
        ...
        function i(n, r) {
            ...
            a[17] = j.Y(), a[18] = j.W();
            var c = j.R(), u = j.T(), f = j.S(), s = [r, j.Q(), n, c, i, !0, f, u];
            n && e++, a[15] = p.h(s), a[0] = e;
            var l = a.na(), m = M.pa(l);
            return m
        }

        var a = new B([2, 2, 4, 4, 4, 1, 1, 4, 4, 3, 2, 2, 2, 2, 2, 1, 2, 1, 1, 1, 1]), e = 0;
        n.F = r, n.sa = i
    }(W || (W = {}));
    var S;
    !function (n) {
        function t(n, t) {
            var r = n.split("."), i = r.length - 1, a = r[i];
            if (a in t) return !0;
